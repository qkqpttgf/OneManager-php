...
$constStr = [
    ...
    'EnvironmentsDescription' => [
        'en-us' => [
            ...
            'forceHttps' => 'if 1, force to redirect to https when using http.',
        ...
        'zh-cn' => [
            ...
            'forceHttps' => '如果填1，当使用HTTP访问时，会强制跳转HTTPS。',
        ...
        'zh-tw' => [
            ...
            'forceHttps' => '如果填1，當使用HTTP訪問時，會強制跳轉HTTPS。',
        ...
        'ja' => [
            ...
            'forceHttps' => '1を記入すると、HTTPアクセスを使用すると、HTTPSが強制的にリダイレクトされます。',
        ...
        'ko-kr' => [
            ...
            'forceHttps' => '1을 입력하면 HTTP 액세스를 사용할 때 HTTPS가 강제로 리디렉션됩니다.',
        ...
        'ar-sa' => [
            ...
            'forceHttps' => 'إذا قمت بملء 1 ، عند استخدام وصول HTTP ، فسيتم إعادة توجيه HTTPS قسرًا.',
