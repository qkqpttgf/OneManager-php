...
$constStr = [
    ...
    'EnvironmentsDescription' => [
        'en-us' => [
            ...
            'domainforproxy' => 'Will replace the xxxxx-my.sharepoint.com with this value.Add &Origindomain=xxxxx-my.sharepoint.com at last',
        ...
        'zh-cn' => [
            ...
            'domainforproxy' => '会将xxxxx-my.sharepoint.com替换成这个值，在目标需要自己设置反代。会加上&Origindomain=原域名',
