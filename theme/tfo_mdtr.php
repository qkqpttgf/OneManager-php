...
<head>
    ...
    <style type="text/css">
        ...
        input{cursor:pointer;padding: 0 8px;height:24px;font-weight:bold;border:1px solid rgba(27,31,35,1);transition-duration: 0.3s;border-radius:16px;background-color:transparent;color:#24292e}
        ...
        .list-table td button:hover,.list-table th button:hover{color:#FFF;background:rgb(3,102,214);border-radius:16px;border:1px solid rgba(27,31,35,.15);box-shadow:0 1px 15px rgba(27,31,35,.15);}        .list-table .size,.list-table .updated_at{text-align:right}
