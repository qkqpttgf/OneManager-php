...
<?php if ($files) { ?>
<?php if (isset($files['children']['head.md'])||isset($files['children']['readme.md'])) { ?><link rel="stylesheet" href="//github.com/typora/typora-default-themes/blob/master/themes/github.css">
