...
<head>
    ...
    <style type="text/css">
        ...
        .list-wrapper{width:96%;margin:0 auto 30px;position:relative;box-shadow:0 0 6px 0 rgb(128,128,128);border-radius:6px;}
        ...
        .mask{position:absolute;left:0px;top:0px;width:100%;background-color:#000;filter:alpha(opacity=80);opacity:0.8;z-index:2;}
