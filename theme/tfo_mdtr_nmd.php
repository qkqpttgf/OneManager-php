...
<body>
<?php echo '<script language="javascript">$(function(){document.onreadystatechange = function(){if(document.readyState == "complete"){$(".ld").fadeOut();}}})</script>'; ?>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;left:0;top:0;right:0;bottom:0;margin: auto; display: block; shape-rendering: auto;" width="178px" height="178px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
<path fill="none" stroke="rgb(3,102,214)" stroke-width="10" stroke-dasharray="128.29446411132812 128.29446411132812" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z" stroke-linecap="round" style="transform:scale(0.5);transform-origin:50px 50px">
