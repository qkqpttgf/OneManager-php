...
<head>
    ...
    <style type="text/css">
        body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:1em;color:#1E90FF;background:url("https://cdn.jsdelivr.net/gh/ldxw/CDN@0.02.7/scfone-theme-js/img/bj.png")}
