...
<head>
    ...
    <style type="text/css">
        ...
        .title{border:1px solid rgba(27,31,35,.15);box-shadow:0 1px 15px rgba(27,31,35,.15);text-align:center;letter-spacing:1px;height: 10px;margin:1rem auto;border:0 none;padding: 16px 16px;text-align:center;background-color:rgba(245,245,245);white-space:nowrap;overflow:hidden;width:fit-content;border-radius:36px;}
