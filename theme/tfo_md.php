...
<head>
    ...
    <style type="text/css">
        ...
        .title:hover{text-shadow:0 1px 15px rgba(27,31,35,0);background-color:rgba(245,245,245);box-shadow:0 1px 15px rgba(27,31,35,.15);}
...
<?php }
    ...
    <?php } ?>
                                    EndTime=new Date();
                                    MiddleStr = '<?php echo getconstStr('EndAt'); ?>:'+EndTime.toLocaleString()+'<br>;';                                    if (newstartsize==0) {
